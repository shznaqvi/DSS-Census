...
public class SyncMother extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " Mother synced." + String.valueOf(json.length() - sSynced) + " Errors.", Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " Mother synced." + String.valueOf(json.length() - sSynced) + " Errors.");
