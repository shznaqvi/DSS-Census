package edu.aku.hassannaqvi.dss_census_short.core;
...
import edu.aku.hassannaqvi.dss_census_short.contracts.CensusContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.CensusContract.censusMember;
import edu.aku.hassannaqvi.dss_census_short.contracts.DeceasedContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.DeceasedContract.DeceasedMember;
import edu.aku.hassannaqvi.dss_census_short.contracts.FormsContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.dss_census_short.contracts.HouseholdContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.HouseholdContract.householdForm;
import edu.aku.hassannaqvi.dss_census_short.contracts.MembersContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.MembersContract.singleMember;
import edu.aku.hassannaqvi.dss_census_short.contracts.MotherContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.MotherContract.MotherTB;
import edu.aku.hassannaqvi.dss_census_short.contracts.SectionKIMContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.UsersContract;
import edu.aku.hassannaqvi.dss_census_short.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.dss_census_short.otherClasses.MothersLst;

import static edu.aku.hassannaqvi.dss_census_short.contracts.SectionKIMContract.singleIm;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "dss-census_short.db";
    public static final String DB_NAME = "dss-census_short_copy.db";
