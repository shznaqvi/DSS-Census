package edu.aku.hassannaqvi.dss_census_sur_monitor.get;
...
public class GetSurFollowUps extends AsyncTask<Void, Void, String> {
    ...
    protected void onPreExecute() {
        ...
        pd.setTitle("Please wait... Processing FollowUps");
        pd.show();
