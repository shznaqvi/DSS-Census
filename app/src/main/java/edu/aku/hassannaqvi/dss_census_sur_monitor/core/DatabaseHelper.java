package edu.aku.hassannaqvi.dss_census_sur_monitor.core;
...
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.CensusContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.CensusContract.censusMember;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.DeceasedContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.DeceasedContract.DeceasedMember;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.FollowUpsContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.FollowUpsContract.FollowUpTable;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.FormsContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.HouseholdContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.HouseholdContract.householdForm;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.MembersContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.MembersContract.singleMember;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.MotherContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.MotherContract.MotherTB;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.SectionKIMContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.UsersContract;
import edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.dss_census_sur_monitor.otherClasses.MothersLst;

import static edu.aku.hassannaqvi.dss_census_sur_monitor.contracts.SectionKIMContract.singleIm;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "dss-census-sur-ra.db";
    public static final String DB_NAME = "dss-census-sur_copy-ra.db";
